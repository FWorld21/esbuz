...
class Address(models.Model):
    ...
    city_uz = models.CharField(max_length=30, verbose_name='Город (УЗБ)', blank=False)
    street_uz = models.CharField(max_length=30, verbose_name='Улица (УЗБ)', blank=False)
    landmark_uz = models.CharField(max_length=40, verbose_name='Ориентир (УЗБ)', blank=True)
